...
public class UpdateBusinessDetailByIdCommandValidator : AbstractValidator<UpdateBusinessDetailByIdCommandRequest>
{
    public UpdateBusinessDetailByIdCommandValidator()
    {
